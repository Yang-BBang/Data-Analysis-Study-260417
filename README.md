...
## Featured Projects
본 프로젝트는 데이터 분석 역량 강화를 위해 학습 목적으로 진행되었습니다. 효율적인 분석 방향성 설정과 코드 구조 설계를 위해 LLM(AI)의 도움을 받았으나, 단순히 결과를 복사하는 것에 그치지 않고 모든 로직을 라인별로 직접 검증하고 뜯어보며 분석 프로세스를 이해하는 데 주력했습니다. 초기 빌드 이후의 분석 로직을 스스로 소화하며 실전 적용 능력을 기르는 데 초점을 맞췄으며, 부족한 부분은 꾸준히 학습해 나갈 예정입니다.

### 1️⃣ 당뇨병 유무 예측 및 임상 핵심 인자 발굴 ([리포트 보기](https://Yang-BBang.github.io/Data-Analysis-Study-260417/R-Language/R-Data-Analysis/당뇨병_유무_예측_및_핵심_인자_발굴.html))
...
### 2️⃣ 대사체 데이터를 활용한 질환 핵심 마커 발굴 ([리포트 보기](https://Yang-BBang.github.io/Data-Analysis-Study-260417/R-Language/R-Data-Analysis/대사체_데이터를_활용한_질환_핵심_마커_발굴.html))
...
### 3️⃣ 멀티오믹스 데이터 통합 기반 질환 핵심 마커 발굴([리포트 보기](https://Yang-BBang.github.io/Data-Analysis-Study-260417/R-Language/R-Data-Analysis/멀티오믹스_통합_기반_질환_핵심_마커_발굴.html))
