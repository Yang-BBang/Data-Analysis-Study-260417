...
### 4️⃣ 멀티오믹스 데이터를 활용한 머신러닝 예측 모델 구축 ([리포트 보기](https://htmlpreview.github.io/?https://github.com/Yang-BBang/Data-Analysis-Study-260417/blob/main/Python-Language/Python-Data-Analysis/멀티오믹스_머신러닝_모델링.ipynb))
