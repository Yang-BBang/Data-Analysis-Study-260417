...
* **Omics Data Analysis**: 대사체 기초 분석 및 멀티오믹스(전사체-대사체) 통합 분석
...
### 3️⃣ 멀티오믹스 데이터 통합 분석 및 상호작용 규명 ([리포트 보기](https://htmlpreview.github.io/?https://github.com/Yang-BBang/Data-Analysis-Study-260417/blob/main/R-Language/R-Data-Analysis/멀티오믹스_데이터_통합_분석.html))
